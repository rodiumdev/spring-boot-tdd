...
public class CustomerControllerIntegrationTest {
  ...
  void addCustomer() throws Exception {
    Customer customer = new Customer("", "John", "Doe", "jdoe@test.com", "555-515-1234",
        "1234 Main St, Smallville KS 66083");
  ...
  void addCustomer_exists() throws Exception {
    Customer customer = new Customer("", "Cally", "Reynolds", "penatibus.et@lectusa.com", "(901) 166-8355",
  ...
  void updateCustomer() throws Exception {
    Customer customer = new Customer("c04ca077-8c40-4437-b77a-41f510f3f185", "Jack", "Bower",
        "quam.quis.diam@facilisisfacilisis.org", "(831) 996-1240", "2 Rockefeller Avenue, Waco, TX 76796");
    ObjectMapper mapper = new ObjectMapper();
    String jsonString = mapper.writeValueAsString(customer);
  ...
  void deleteCustomer() throws Exception {
    this.mockMvc.perform(delete("/customers/3b6c3ecc-fad7-49db-a14a-f396ed866e50"))
